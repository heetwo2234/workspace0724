...
CREATE TABLE TB_BOOK(
    ...
    BK_TITLE    VARCHAR2(300)     CONSTRAINT BOOK__NN_TITLE NOT NULL,
...
CREATE TABLE TB_MEMBER(
    MEMBER_NO       NUMBER          CONSTRAINT   MEMBER_PL       PRIMARY KEY,
    MEMBER_ID       VARCHAR2(50)    CONSTRAINT   MEMBER_UQ_ID    UNIQUE,
    MEMBER_PWD      VARCHAR2(200)   CONSTRAINT   MEMBER_NN_PWD   NOT NULL,
    MEMBER_NAME     VARCHAR2(100)   CONSTRAINT   MEMBER_NN_NAME  NOT NULL,
