...
<body>
    ...
    <%--
        ...
        3. 액션태그(Action Tag)
            - JSP에서 특징 동작을 수행하도록 지시하는 태그
            - XML문법기반으로 JSP기능을 확장
            >> 표준액션태그 : 태그의 시작이 <jsp:태그명>이다 jsp:이라는 접두어를 사용
    ...
    --%>
		...
		<h3>JSTL 선언방법</h3>
		<p>
			JSTL을 사용하려면 JSP페이지 상단에 taglib지시어를 선언해야 한다. <br>
			<%-- <%@ taglib prefix="접두어" url="라이브러리파일상의 uri주소% %> --%>
		</p>
		
		<h3>Cunstom Action Tag (JSTL 주요 라이브러리)</h3>
